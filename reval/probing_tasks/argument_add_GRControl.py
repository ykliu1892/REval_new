...
@date: 20.11.29
@original author: leonhard.hennig@dfki.de
@editor: Ke Liu kliu0@umass.edu
Modified code to probe appositional and noun compound modifiers (control task). 
...
def generate(
    ...
    logger.info("Generating dataset for probing task: ArgumentAddGrammaticalRoleControl")
